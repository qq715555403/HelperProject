...
static const float initialProgressValue = 0.2;
...
//    NSLog(@"\nnavigationType==%ld,\nrequest.URL.absoluteString==%@,\nrequest.URL.fragment==%@,\nrequest.mainDocumentURL==%@,\nrequest.URL.scheme==%@",(long)navigationType,request.URL.absoluteString,request.URL.fragment,request.mainDocumentURL,request.URL.scheme);
