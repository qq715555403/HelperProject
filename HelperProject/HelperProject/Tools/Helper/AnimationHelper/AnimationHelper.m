...
#pragma mark - Preset Animation-CATransition、UIViewAnimation和CABasicAnimation
#pragma mark - CATransition动画-layer层的动画
...
//#pragma mark - Private API-私有API-全是CATransition动画
...
+(CABasicAnimation *)opacityForever_Animation:(float)time //永久闪烁的动画
{
    ...
    animation.autoreverses=YES;  //比如：从左移到右边，如果为yes，则会循环从右边移到左边，其他同理
...
+(CABasicAnimation *)moveY:(NSNumber *)y duration:(float)time //纵向移动
{
