...
//    self.lblInfo=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, kScreen_Width, 40)];
//    self.lblInfo.text=@"请选择";
...
//        self.title=[NSString stringWithFormat:@"%@-%@-%@",self.selectedProvince,self.selectedCity,self.selectedArea];
    }
